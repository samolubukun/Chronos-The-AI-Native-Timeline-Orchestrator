...
export function CreateChronicleModal({ isOpen, onClose, onCreate }) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[425px] border-4 border-black rounded-none shadow-[12px_12px_0px_0px_rgba(139,92,246,1)] p-8 bg-white text-slate-950">
                <DialogHeader>
                    <div className="w-14 h-14 border-2 border-black flex items-center justify-center mb-6 shadow-[4px_4px_0px_0px_rgba(139,92,246,1)] bg-white overflow-hidden p-1.5">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 py-4">
                    ...
                    <DialogFooter>
                        <Button 
                            type="submit" 
                            disabled={!name.trim()}
                            className="w-full bg-violet-600 hover:bg-violet-700 text-white rounded-none border-2 border-black font-black uppercase tracking-widest h-12 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 hover:shadow-none transition-all"
                        >
                            Create Chronicle
                        </Button>
                    </DialogFooter>
